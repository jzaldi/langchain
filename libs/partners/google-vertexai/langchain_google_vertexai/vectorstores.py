...
class MatchingEngine(VertexAIVectorStore):
    """`VertexAIVectorSearch` retriever alias for backwards compatibility.
    DEPRECATED: Use `VertexAIVectorStore` instead.
    """
    ...
    def __init__(self, **data: Any):
        ...
        warnings.warn(
            "MatchingEngine is deprecated, use VertexAIVectorStore",  # noqa: E501
            DeprecationWarning,
        )
